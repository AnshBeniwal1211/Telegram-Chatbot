...
voice = user.get_voices_by_name("Serena")[0]


messages = [{"role": "system", "content": "You are a helpful assistant and You will refer to me as Ansh and your name is Neural"}]
